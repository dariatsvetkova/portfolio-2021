...
const IndexPage = () => (
  <Layout>
    ...
    <section>
      <h3>About Me</h3>
      <p>A friend once described me as a throwback to the Renaissance era. While not nearly so old, I do enjoy creativity in its various forms: <a href="https://soundcloud.com/liuthsounds" target="_blank">music</a>, design, <a href="https://ko-fi.com/dariascananigans/posts" target="_blank">creative writing</a>, and, most of all, programming.</p>
      ...
      <p>Currently, I am <a href="https://www.linkedin.com/in/daria-tsvetkova/" target="_blank">looking for full-time opportunities</a> in front-end development. I’m eager to learn from experienced developers and to apply my skills to help the right business grow.</p>
    </section>
    <section>
      <h3>Skills</h3>
