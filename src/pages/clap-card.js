...
const ClapCard = () => (
  <Layout>
    ...
    <div className="page-container clap-card">
      <header>
        <nav>
      ...
      <main>
        <section className="project-descr">
          ...
          <div className="column">
            <h5>Links</h5>
            <p><a className="text-link" href="https://github.com/dariatsvetkova/clapcard" target="_blank" rel="noreferrer">View code</a></p>
            <p><a className="text-link" href="https://youtu.be/09y7xGG3jWk" target="_blank" rel="noreferrer">View a video demo</a></p>
          </div>
        ...
        <nav className="prev-next">
          <Link className="text-link prev" to="/game-of-15">
            <span className="icon"><BsArrowLeft /></span>
            Previous project
          </Link>
          <Link className="text-link next" to="/tap-tempo">
            Next project
